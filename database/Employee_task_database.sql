...
-- Dump completed on 2026-09-10 15:39:27
-- MySQL dump 10.13  Distrib 8.0.46, for Win64 (x86_64)
--
-- Host: localhost    Database: nestjs_basic_demo
-- ------------------------------------------------------
-- Server version	8.0.46
...
CREATE TABLE `activity` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_2743f8990fde12f9586287eb09f` (`taskId`),
  CONSTRAINT `FK_2743f8990fde12f9586287eb09f` FOREIGN KEY (`taskId`) REFERENCES `tasks` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `activity` VALUES ('1e752c75-3d2f-4bd7-bc13-fe5efd05b564','New task assigned',' security check was assigned to dddd','dc11f26b-e724-4371-a303-8e17dff9d105','2026-09-08 17:02:17.145330'),('e3c651e2-ba39-46aa-90f4-24d36f79a9d9','New task assigned','kkkhhjsssss was assigned to piyush','6333b2e0-6d68-4d08-a8e3-771d183ab3d5','2026-09-10 12:05:40.981945');
...
CREATE TABLE `subtasks` (
  ...
  `taskId` varchar(255) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_bde15cf8f7b07bb4ccad8ef6fa3` (`taskId`),
  CONSTRAINT `FK_bde15cf8f7b07bb4ccad8ef6fa3` FOREIGN KEY (`taskId`) REFERENCES `tasks` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tasks` (
  ...
  `acceptanceDeadline` varchar(255) NOT NULL,
  `declineReason` varchar(255) DEFAULT NULL,
  `declineComment` varchar(255) DEFAULT NULL,
  `createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
  `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6),
  PRIMARY KEY (`id`),
  KEY `FK_1a926f12083f0d5719711fdef50` (`assignedEmployeeId`),
  CONSTRAINT `FK_1a926f12083f0d5719711fdef50` FOREIGN KEY (`assignedEmployeeId`) REFERENCES `users` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tasks` VALUES ('6333b2e0-6d68-4d08-a8e3-771d183ab3d5','kkkhhjsssss','vvvvvvvvvvvvvvvvvvvvvvv',4,'Low','Pending Acceptance','2026-09-12T12:05','2026-09-10T18:05',NULL,NULL,'2026-09-10 12:05:40.962668','2026-09-10 12:05:40.962668'),('79596abd-4ca3-4f4f-8126-238bed2c5b68','Build Login Page','qqqqqqqqqq',1,'Medium','Pending Acceptance','2026-09-15T09:46','2026-09-08T20:46',NULL,NULL,'2026-09-08 09:46:32.488870','2026-09-08 09:46:32.488870'),('aac398be-2e94-4a1e-8b84-d2852f956049','Responsive Layout Fixes','rrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr',1,'Medium','Pending Acceptance','2026-09-11T15:12','2026-09-09T15:12',NULL,NULL,'2026-09-08 15:12:43.827414','2026-09-08 15:12:43.827414'),('d1c98e1d-585e-4f86-b0af-ee1cc32379a4','tttttttttsssssssssssssssssssssss','sdfsdfdfsdf',5,'Medium','Pending Acceptance','2026-09-24T12:27','2026-09-18T12:27',NULL,NULL,'2026-09-08 12:27:40.812385','2026-09-08 12:27:40.812385'),('dc11f26b-e724-4371-a303-8e17dff9d105',' security check','security check',6,'Low','Pending Acceptance','2026-09-12T17:02','2026-09-09T17:02',NULL,NULL,'2026-09-08 17:02:17.136006','2026-09-08 17:02:17.136006'),('f9488c08-07b8-4171-a864-ee7c1aed663d','tttttttttsssssssssssssssssssssss','aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa',5,'High','Pending Acceptance','2026-09-19T15:13','2026-09-11T15:13',NULL,NULL,'2026-09-08 15:13:40.342094','2026-09-08 15:13:40.342094');
...
INSERT INTO `users` VALUES (1,'Vimal Chaudhary','chaudhary123@gmail.om','IT','','Employee','local',NULL),(2,'aarav','aarav@gmail.com','IT','','Employee','local',NULL),(3,'ayush','ayush@gmail.com','sales','','Employee','local',NULL),(4,'piyush','piyush@gmail.com','sales','','Employee','local',NULL),(5,'aarush','bhola@gmail.com','IT','','Employee','local',NULL),(6,'dddd','afkni2@gmail.com','DevOPs','','Employee','local',NULL),(7,'ssss','lalala@gmail.com','OPS','','Employee','local',NULL),(9,'satyam','satyam@gmail.com','IT','','Employee','local',NULL),(10,'ashu','ashu@gmail.com','Finance','','Employee','local',NULL),(11,'akgj','akg@gmail.com','wrrrgv','','Employee','local',NULL),(12,'sarthak','sarthak@gmail.com','AI','','Employee','local',NULL),(13,'dgdgd','asf@gmail.com','asd','','Employee','local',NULL),(14,'asdsad','asdas@gmail.com','dfkds','','Employee','local',NULL),(15,'AARAV PANWAR','aarav.panwar@intercert.com','IT','$2b$10$zY5ph/KKBbJ4q7M5.r06Qug4GCg4E.wc4yWCdavmVynS6tfJL5WwC','Employee','local',NULL);
...
-- Dump completed on 2026-09-10 15:39:28
-- MySQL dump 10.13  Distrib 8.0.46, for Win64 (x86_64)
--
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2026-08-31 11:10:03',NULL),('diagnostics.include_raw','OFF','2026-08-31 11:10:03',NULL),('ps_thread_trx_info.max_length','65535','2026-08-31 11:10:03',NULL),('statement_performance_analyzer.limit','100','2026-08-31 11:10:03',NULL),('statement_performance_analyzer.view',NULL,'2026-08-31 11:10:03',NULL),('statement_truncate_len','64','2026-08-31 11:10:03',NULL);
...
-- Dump completed on 2026-09-10 15:39:29
